...
<div class="container">
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4">
			...
			<input class= "btn btn-success btn-block visible-xs-block" type="submit" value="Logi sisse MOB">
			<input class= "btn btn-success btn-ss hidden-xs" type="submit" value="Logi sisse">
